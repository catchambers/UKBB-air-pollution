...
libraries <- c("survival", "ggplot2", "rstudioapi")
...
##Could move code in data_process to this section
##chip option not functional currently

```{r infile, include=FALSE}
selection <- get_input()
if(selection == 1){
  df <- readRDS("C:/Users/Caitlyn/Box/Research/air_pollution/Datasets/lung.rds")
} else if (selection == 2){
  df <- readRDS("C:/Users/Caitlyn/Box/Research/air_pollution/Datasets/chip.rds")
}

attach(df)
```
##Output showing which selection chosen in document
...
##I haven't generated these variables.
```{r model 2}
